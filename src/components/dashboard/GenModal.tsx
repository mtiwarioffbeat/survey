...
const GenModal = () => {
    ...
    const handleConfirm = async () => {
        ...
        const data = {
            ...
            to_edit:GenModalConfirm.to_edit,
        }
        try {
            ...
            dispatch(setGenModalConfirm({ ...GenModalConfirm, to_delete: false, survey_id: -1, survey_name: '', to_publish: false,to_edit:false }))
            return
        } catch (error: any) {
                ...
                <div className="flex flex-col gap-4">
                    <h3 className="text-xl font-semibold text-slate-800">
                        ...
                        <span className="text-red-600">
                            {GenModalConfirm.to_delete
                                ? "Delete"
                                : GenModalConfirm.to_publish
                                    ? "Publish"
                                    : "Open Edit Mode for"}{" "}
                            {GenModalConfirm.survey_name}
                        </span>
                        ?
                    </h3>
