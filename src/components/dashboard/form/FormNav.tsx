...
export default function FormNav() {
    return (
        <div>
            <nav className=" border-gray-200  bg-white shadow w-full">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4">
                    <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
                      <FaFileAlt className="text-3xl text-indigo-700 cursor-pointer"  />
                        <span className="self-center text-2xl hover:underline  whitespace-nowrap">Untitled form</span>
                    </a>
                    <div className="hidden w-full md:block md:w-auto" id="navbar-default ">
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row       md:border-0 ">
                            <li>
